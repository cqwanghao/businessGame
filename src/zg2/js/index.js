(function () {
  $(function () {
    ...
    var o1 = getQueryString("o1") || '0';
    var phx_wake_up_source = getQueryString("phx_wake_up_source") || '0';
    var phx_wake_up_type = getQueryString("phx_wake_up_type") || '0';
    var friendid = '';
    var globImg = '';
    // 同步用户信息
    ...
    // 获取分享图片
    if (userInfo.openId) {
      $.get('https://h5-zhenguo.meituan.com/shorturl?url=' + encodeURIComponent('https://zhenguo.meituan.com/pub/x_group_spread/share.html?o1=' + userInfo.openId + '&phx_wake_up_type=' + phx_wake_up_type + '&phx_wake_up_type=' +phx_wake_up_type), function(data) {
        var _shortUrl = data.data.shortUrl;
        var _encodeUrl = 'https://ms1.meituan.net/qrc/s?c=' + encodeURIComponent(_shortUrl.replace('http://dpurl.cn', 'https://zhenguo.meituan.com'))
      ...
      $.post('https://zhenguo.project.peidikeji.cn/api/share/' + o1, function (data) {
    ...
    function getZanList() {
      ...
      // 获取数据
      $.post("https://zhenguo.project.peidikeji.cn/api/zan_list/" + userInfo.openId + "?page_size=5000&page=1", function (data) {
        ...
        var qrcodeTimer = setTimeout(function () {
          html2canvas(document.querySelector('.poster'), {
            ...
            $.post('https://zhenguo.project.peidikeji.cn/api/share', {
              ...
              headimgurl: userInfo.avatarUrl ? userInfo.avatarUrl : 'http://p.kengdie.com/touxiang/01/40/321446496.jpg',
              share_image: _base64,
            }, function () {
              layer.close(loading);
            });
    ...
    $('.page6 .submit').on('click', function () {
      ...
      $.post('https://zhenguo.project.peidikeji.cn/api/zan/' + o1, {
        nickname: userInfo.nickName,
        openid: userInfo.openId,
        headimgurl: userInfo.avatarUrl ? userInfo.avatarUrl : 'http://p.kengdie.com/touxiang/01/40/321446496.jpg',
        type: _type
    ...
    function ready() {
      ...
      wx.miniProgram.postMessage({
        data: {
          ...
          data: { // 自定义分享配置
            title: '你愿意花多少睡我这一晚',
            path: /share/.test(location.pathname) ? 'https://zhenguo.meituan.com/pub/x_group_spread/share.html' : 'https://zhenguo.meituan.com/pub/x_group_spread/index.html', // 小程序页面或者标准的'https://'链接
            imageUrl: /share/.test(location.pathname) ? 'https://s3plus.meituan.net/v1/mss_65766da973d14523b3d781fe3ac2bbac/www-public/pub/x_group_spread/x-share-result.jpeg' : 'https://s3plus.meituan.net/v1/mss_65766da973d14523b3d781fe3ac2bbac/www-public/pub/x_group_spread/x-share-index.jpeg',
            uri: location.href // 必传，当前页面URL，用于校验
          }
        }
      })
    }
